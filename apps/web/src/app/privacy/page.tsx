...
export const metadata = {
  title: "Privacy",
  description: "How the ProtoTower invite-only beta handles account and tower data.",
};
  ...
  return (
    <main id="main-content">
      ...
      <article className="legal-shell">
        ...
        <h1>Privacy in the invite-only beta.</h1>
        ...
        <section>
          ...
          <ul>
            <li>Your invited email address is held by the authentication provider.</li>
            <li>
        ...
        <section>
          ...
          <p>
            ...
            the invite-only beta. Cloudflare hosts the application, Supabase provides authentication
            and database storage, and Resend delivers authentication email. Email link and open
        ...
        <section>
          ...
          <p>
            Account data is retained while your invitation remains active. You may request deletion
            at any time. A verified request will be completed within seven calendar days, including
            the authentication record, towers, tower membership, and practice history, subject only
            to a temporary provider backup lifecycle.
          </p>
          <p>
        ...
        <section>
          ...
          {supportEmail ? (
            ...
            <p>Before production opens, contact the person who invited you to ProtoTower.</p>
          )}
        </section>
      </article>
      <SiteFooter />
