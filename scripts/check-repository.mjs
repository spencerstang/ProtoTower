...
const required = [
  ...
  "docs/decisions/0010-magic-link-authenticated-personal-towers.md",
  "docs/decisions/0012-invite-only-production-beta.md",
  "docs/architecture/milestone-1-handoff.md",
  "docs/architecture/milestone-5-invite-only-production.md",
  "docs/decisions",
  "docs/security",
  "docs/operations",
  ...
  "docs/operations/milestone-5-gate.md",
  "docs/operations/production-deployment.md",
  "docs/product/milestone-5-scope.md",
  "docs/operations/alpha-account-deletion.md",
  "docs/releases",
  "docs/releases/milestone-1-validation.md",
  "docs/releases/milestone-2-validation.md",
  "docs/releases/milestone-3-validation.md",
  "docs/releases/milestone-5-validation.md",
  "docs/security/threat-model-protocol-catalog.md",
  "docs/security/threat-model-authenticated-towers.md",
  "docs/security/threat-model-production-launch.md",
  "scripts",
  ".github/workflows",
  "AGENTS.md",
  "README.md",
